#Desenvolva um programa que deve ler um arquivo csv intitulado “notas_alunos.csv”. O arquivo
...
#O programa lerá esse arquivo e criará duas colunas. A primeira coluna será “media”, que terá a média das
# duas notas do aluno. A segunda será “situacao”, com os valores: APROVADO ou REPROVADO.

#O aluno que tiver mais de 5 faltas ou possuir média menor que sete, será reprovado. O programa deverá
# salvar esse novo dataframe com o nome “alunos_situacao.csv”.
...
print('  ')
print('-----------------RESULTADO----------------')
print('=> A média geral da turma é {:.1f};'.format(media_geral))
